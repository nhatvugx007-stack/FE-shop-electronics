      ...
      <section className="bg-gradient-to-r from-green-50 to-green-100">
        <div className="container mx-auto px-4 py-8 grid md:grid-cols-4 gap-6">
          ...
          <div className="bg-white rounded-lg p-4 shadow-sm hidden md:block">
            <div className="flex items-center space-x-2 mb-4 font-semibold text-gray-800">
              <Menu size={20} />
              <span>All Departments</span>
            </div>
            <ul className="space-y-2">
              {categories.map((cat, idx) => (
                <li key={idx}><a href="#" className="text-gray-600 hover:text-green-600 text-sm">{cat}</a></li>
              ))}
            </ul>
          </div>
          ...
          <div className="md:col-span-3 space-y-6">
            ...
            <div className="bg-white rounded-lg p-4 shadow-sm">
              <div className="flex flex-col md:flex-row gap-3">
                <input type="text" placeholder="What do you need?" className="flex-1 px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500" />
              ...
              <div className="flex items-center mt-4 text-gray-600">
                ...
                <div>
                  <div className="font-semibold text-gray-800">+65 11.188.888</div>
                  <div className="text-sm">support 24/7 time</div>
                </div>
              </div>
            </div>
